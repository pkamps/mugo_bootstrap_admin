...
<table class="table" summary="{'List of class groups'|i18n( 'design/admin/class/grouplist' )}">
<tr>
...
{section show=$latest_classes}
    ...
    <table class="table" summary="{'List of recently modified classes'|i18n( 'design/admin/class/grouplist' )}">
    <tr>
        <th>{'Name'|i18n( 'design/admin/class/grouplist')}</th>
