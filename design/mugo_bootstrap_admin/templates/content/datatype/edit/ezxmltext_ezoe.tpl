...
<!-- Start editor -->
    ...
    <div class="oe-window" data-id="{$attribute.id}" data-version-nr="{$attribute.version}" id="attribute-{$attribute.id}">
    ...
    <div class="block">
        ...
        eZOeAttributeSettings['setup' ] = function(ed)
        {ldelim}
            ed.onChange.add(function(ed, l)
            {ldelim}
                $( '#attribute-' + {$attribute.id} ).autosaveattribute( 'save', l.content );
                {rdelim});
        {rdelim};
